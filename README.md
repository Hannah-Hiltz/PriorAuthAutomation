...
The most underappreciated number is turnaround time. Three and a half days to three minutes doesn't just save money. It also means patients with time-sensitive diagnoses get treatment decisions faster. For a patient awaiting authorization for cancer immunotherapy or a biologic for severe disease, that delta is clinically meaningful.
